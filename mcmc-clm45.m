...
J1=(diff2.^2)./(2*(scalar_sd*log_soilcarbon_o_total_NCSCD).^2);
diff2=log_soilcarbon_M_100_200-log_soilcarbon_o_NCSCD200;
J2=(diff3.^2)./(2*(scalar_sd*log_soilcarbon_o_NCSCD200).^2);
diff3=log_soilcarbon_M_200_300-log_soilcarbon_o_NCSCD300;
J3=(diff4.^2)./(2*(scalar_sd*log_soilcarbon_o_NCSCD300).^2);
J_new=nansum(J1(:))+nansum(J2(:))+nansum(J3(:));
delta_J = J_new-J_old;
